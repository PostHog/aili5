...
IMPORTANT RULES:
- First, look at the drawing and make your honest guess
- IGNORE WHAT THE GENIE SAID TO THE PLAYER. YOU ARE THE JUDGE.
- Say what you think it is BEFORE checking the answer
- Use the display_guess_result tool: passed=true if your guess matches (or is close enough), passed=false if you got it wrong
